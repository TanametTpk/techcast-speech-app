...
# 
# Use This function as facade
#
def list_macro(name):
    return commands["list"](name, options["filename"])

def update_macro(old_name, new_name):
    update(old_name, new_name, options["filename"])
    return list_macro(new_name, options["filename"])

def record_macro(name):
    commands["record"](name, options["filename"])
    return list_macro(name, options["filename"])

def remove_macro(name):
    commands["remove"](name, options["filename"])
    return list_macro(name, options["filename"])

def play_macro(name):
    commands["play"](name, options["filename"])
    return list_macro(name, options["filename"])